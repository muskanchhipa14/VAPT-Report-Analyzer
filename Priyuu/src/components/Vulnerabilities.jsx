  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Left Column: Create Form (Input) */}
        <div className="lg:col-span-5 bg-white p-5 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-md font-semibold text-gray-700 mb-3 border-b pb-2">Add Vulnerability Record</h3>
        ...
        {/* Right Column: Vulnerabilities Table (Output) */}
        <div className="lg:col-span-7 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-4 border-b border-gray-200 bg-gray-50/50">
            <h3 className="text-md font-semibold text-gray-700">Vulnerabilities List</h3>
          </div>
