  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
        <h3 className="text-md font-semibold text-gray-700 mb-3">Upload VAPT PDF Report</h3>
        <form onSubmit={handleUpload} className="flex flex-col sm:flex-row items-start sm:items-end gap-4">
          ...
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded text-sm shrink-0"
          >
            Upload Report
          </button>
        </form>
